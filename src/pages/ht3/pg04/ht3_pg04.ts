...
import { Ht3Pg04Data } from './ht3_pg04.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg04',
  templateUrl: 'ht3_pg04.html',
})
export class Ht3Pg04Page {

	/* Common */
	pgConfig = new Ht3PgConfig(4);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg04Page');
	}
