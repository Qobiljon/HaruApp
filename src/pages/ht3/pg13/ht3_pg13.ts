...
import { Ht3Pg13Data } from './ht3_pg13.data';
import { Ht3Pg08Data } from '../pg08/ht3_pg08.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg13',
  templateUrl: 'ht3_pg13.html',
})
export class Ht3Pg13Page {

	/* Common */
	pgConfig = new Ht3PgConfig(13);
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneTodayFeelRating) {
			...
			if (this.dtPg.countUcFeelRating11 == -1) {
				this.util.toast('이때의 기분평점을 선택하세요.');
				return false;
	...
	showPage()
	{
		...
		} else if (this.item.ht_userdata == this.dtPg.sceneUcAudio10) {
	...
	sendUcFeelRating11()
	{
		console.log("sendUcFeelRating11", this.dtPg.countUcFeelRating11);
