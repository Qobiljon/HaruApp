...
import { Ht3Pg01Data } from './ht3_pg01.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg01',
  templateUrl: 'ht3_pg01.html',
})
export class Ht3Pg01Page {

	/* Common */
	pgConfig = new Ht3PgConfig(1);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg01Page');
	}
