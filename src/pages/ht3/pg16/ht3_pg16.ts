...
import { Ht3Pg16Data } from './ht3_pg16.data';
import { Ht3Pg08Data } from '../pg08/ht3_pg08.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg16',
  templateUrl: 'ht3_pg16.html',
})
export class Ht3Pg16Page {

	/* Common */
	pgConfig = new Ht3PgConfig(16);
