...
import { Ht3Pg38Data } from './ht3_pg38.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg38',
  templateUrl: 'ht3_pg38.html',
})
export class Ht3Pg38Page {

	/* Common */
	pgConfig = new Ht3PgConfig(38);
	end_zone_num = 4;
