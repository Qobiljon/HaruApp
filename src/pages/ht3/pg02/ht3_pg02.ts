...
import { Ht3Pg02Data } from './ht3_pg02.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg02',
  templateUrl: 'ht3_pg02.html',
})
export class Ht3Pg02Page {

	/* Common */
	pgConfig = new Ht3PgConfig(2);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg02Page');
	}
