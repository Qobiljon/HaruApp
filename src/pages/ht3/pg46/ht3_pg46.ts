...
import { Ht3Pg46Data } from './ht3_pg46.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg46',
  templateUrl: 'ht3_pg46.html',
})
export class Ht3Pg46Page {

	/* Common */
	pgConfig = new Ht3PgConfig(46);
