...
import { Ht3Pg27Data } from './ht3_pg27.data';
...
@IonicPage()
@Component({
  selector: 'ht3-page-pg27',
  templateUrl: 'ht3_pg27.html',
})
export class Ht3Pg27Page {

	/* Common */
	pgConfig = new Ht3PgConfig(27);
	end_zone_num = 3;
	...
	/* User Custom */
	dtPg1st = new Ht3Pg19Data();
	dtPg2nd = new Ht3Pg20Data();
	dtPg3rd = new Ht3Pg21Data();
	dtPg4th = new Ht3Pg26Data();

	dtPg = new Ht3Pg27Data();
	...
	loadUcData()
	{
		...
		let dtPg1st = new Ht3Pg19Data();
		dtPg1st = this.storage.getObject('dtPg19');
		...
		let dtPg3rd = new Ht3Pg21Data();
		dtPg3rd = this.storage.getObject('dtPg21');
		...
		let dtPg4th = new Ht3Pg26Data();
		dtPg4th = this.storage.getObject('dtPg26');
