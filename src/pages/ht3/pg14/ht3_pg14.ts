...
import { Ht3Pg14Data } from './ht3_pg14.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg14',
  templateUrl: 'ht3_pg14.html',
})
export class Ht3Pg14Page {

	/* Common */
	pgConfig = new Ht3PgConfig(14);
