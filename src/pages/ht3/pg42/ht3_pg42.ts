...
import { Ht3Pg42Data } from './ht3_pg42.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg42',
  templateUrl: 'ht3_pg42.html',
})
export class Ht3Pg42Page {

	/* Common */
	pgConfig = new Ht3PgConfig(42);
