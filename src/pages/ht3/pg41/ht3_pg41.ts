...
import { Ht3Pg41Data } from './ht3_pg41.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg41',
  templateUrl: 'ht3_pg41.html',
})
export class Ht3Pg41Page {

	/* Common */
	pgConfig = new Ht3PgConfig(41);
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData21 && this.dtPg.resultUcInput17 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData18;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData18 && this.dtPg.resultUcInput17 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput17;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData21 && this.dtPg.resultUcInput17 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData19;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData19 && this.dtPg.resultUcInput17 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput17;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData21 && this.dtPg.resultUcInput17 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData20;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData20 && this.dtPg.resultUcInput17 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput17;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput17 && this.dtPg.resultUcInput17 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData18;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData18 && this.dtPg.resultUcInput17 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData21;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput17 && this.dtPg.resultUcInput17 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData19;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData19 && this.dtPg.resultUcInput17 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData21;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput17 && this.dtPg.resultUcInput17 == 3) {
				// 분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData20;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData20 && this.dtPg.resultUcInput17 == 3) {
				// 분기#3
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput14) {
			...
			if ((this.dtPg.resultUcInput16[1] == false &&
				...
				this.dtPg.resultUcInput16[9] == false &&
				this.dtPg.resultUcInput16[10] == false &&
				this.dtPg.resultUcInput16[11] == false &&
				this.dtPg.resultUcInput16[12] == false) )
			{
				this.util.toast('보기의 답을 선택하세요.');
				return false;
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput14) {
			this.showUcInput14();
