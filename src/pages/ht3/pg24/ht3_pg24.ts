...
import { Ht3Pg24Data } from './ht3_pg24.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg24',
  templateUrl: 'ht3_pg24.html',
})
export class Ht3Pg24Page {

	/* Common */
	pgConfig = new Ht3PgConfig(24);
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData26 && this.dtPg.resultUcInput19 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData22;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput20 && this.dtPg.resultUcInput19 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput19;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData26 && this.dtPg.resultUcInput19 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData25;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput23 && this.dtPg.resultUcInput19 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput19;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput19 && this.dtPg.resultUcInput19 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcInput20;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData22 && this.dtPg.resultUcInput19 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData26;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput19 && this.dtPg.resultUcInput19 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcInput23;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData25 && this.dtPg.resultUcInput19 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData26;
			} else {
				this.pgConfig.sceneNumber++;
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput9) {
			...
			if (this.dtPg.resultUcInput20[1] == false &&
				this.dtPg.resultUcInput20[2] == false &&
				this.dtPg.resultUcInput20[3] == false &&
				this.dtPg.resultUcInput20[4] == false &&
				this.dtPg.resultUcInput20[5] == false &&
				this.dtPg.resultUcInput20[6] == false &&
				this.dtPg.resultUcInput20[7] == false)
			{
				this.util.toast('보기의 항목을 선택하세요.');
				return false;
			...
			if (this.dtPg.resultUcInput30 == -1) {
				this.util.toast('보기의 답을 선택하세요.');
				return false;
			...
			if (this.dtPg.resultUcInput32 == -1) {
				this.util.toast('보기의 답을 선택하세요.');
				return false;
	...
	selectMinDown(num)
	{
		if (num == 13)
		{
			if (this.dtPg.resultUcInput13 > 0)
				this.dtPg.resultUcInput13 -= 1;
		} else if (num == 14) {
			if (this.dtPg.resultUcInput14 > 0)
				this.dtPg.resultUcInput14 -= 1;
		} 
	}
	...
	selectMinUp(num)
	{
		if (num == 13)
		{
			if (this.dtPg.resultUcInput13 < 29)
				this.dtPg.resultUcInput13 += 1;
		} else if (num == 14) {
			if (this.dtPg.resultUcInput14 < 29)
				this.dtPg.resultUcInput14 += 1;
		}
	}
	...
	changeAmPmUp(num)
	{
		if (num == 21)
		{
			if (this.dtPg.resultUcInput21.ampm == '오전') {
				this.dtPg.resultUcInput21.ampm = '오후';
			} else {
				this.dtPg.resultUcInput21.ampm = '오전';
			}
		} else if (num == 24) {
			if (this.dtPg.resultUcInput24.ampm == '오전') {
				this.dtPg.resultUcInput24.ampm = '오후';
			} else {
				this.dtPg.resultUcInput24.ampm = '오전';
			}
		}
	}
	...
	changeHourUp(num)
	{
		if (num == 21)
		{
			if (this.dtPg.resultUcInput21.hour == 12) {
				this.dtPg.resultUcInput21.hour = 1;
			} else {
				this.dtPg.resultUcInput21.hour += 1;
			}
		} else if (num == 24) {
			if (this.dtPg.resultUcInput24.hour == 12) {
				this.dtPg.resultUcInput24.hour = 1;
			} else {
				this.dtPg.resultUcInput24.hour += 1;
			}
		}
	...
	changeHourDown(num)
	{
		if (num == 21)
		{
			if (this.dtPg.resultUcInput21.hour == 1) {
				this.dtPg.resultUcInput21.hour = 12;
			} else {
				this.dtPg.resultUcInput21.hour -= 1;
			}
		} else if (num == 24) {
			if (this.dtPg.resultUcInput24.hour == 1) {
				this.dtPg.resultUcInput24.hour = 12;
			} else {
				this.dtPg.resultUcInput24.hour -= 1;
			}
		}
	...
	changeMinUp(num)
	{
		if (num == 21)
		{
			if (this.dtPg.resultUcInput21.min == 55) {
				this.dtPg.resultUcInput21.min = 0;
			} else {
				this.dtPg.resultUcInput21.min += 5;
			}
		} else if (num == 24) {
			if (this.dtPg.resultUcInput24.min == 55) {
				this.dtPg.resultUcInput24.min = 0;
			} else {
				this.dtPg.resultUcInput24.min += 5;
			}
		}
	}
	...
	changeMinDown(num)
	{
		if (num == 21)
		{
			if (this.dtPg.resultUcInput21.min == 0) {
				this.dtPg.resultUcInput21.min = 55;
			} else {
				this.dtPg.resultUcInput21.min -= 5;
			}
		} else if (num == 24) {
			if (this.dtPg.resultUcInput24.min == 0) {
				this.dtPg.resultUcInput24.min = 55;
			} else {
				this.dtPg.resultUcInput24.min -= 5;
			}
		}
	...
	sendUcInput20()
	{
		...
		if (this.dtPg.resultUcInput20[1] == false &&
			...
			this.dtPg.resultUcInput20[7] == false)
		{
			this.util.toast('보기의 요일을 선택하세요.');
			return;
		} else {
			this.util.alert('해당 요일을 선택하셨습니다.');
	...
	sendUcInput23()
	{
		...
		if (this.dtPg.resultUcInput23 == -1)
		{
			this.util.toast('보기의 요일을 선택하세요.');
			return;
		} else {
			this.util.toast('해당 요일을 선택하세요.');
	...
	sendUcInput30()
	{
		...
		if (this.dtPg.resultUcInput30 == -1)
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput30 == this.dtPg.passUcInput30) {
			this.util.alert('잘 하셨습니다.');
			this.dtPg.isUcInput30 = true;
			return;
		} else {
			this.dtPg.countUcInput30--;

			if (this.dtPg.countUcInput30 >= 0) {
				this.util.alert('다시 한 번 생각해보세요.');
			} else {
				this.util.alert('응답 횟수를 초과하였습니다.');
				this.dtPg.isUcInput30 = true;
				this.dtPg.resultUcInput30 = this.dtPg.passUcInput30;
			}
	...
	sendUcInput31()
	{
		...
		if (this.dtPg.resultUcInput31 == -1)
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput31 == this.dtPg.passUcInput31) {
			this.util.alert('잘 하셨습니다.');
			this.dtPg.isUcInput31 = true;
			return;
		} else {
			this.dtPg.countUcInput31--;

			if (this.dtPg.countUcInput31 >= 0) {
				this.util.alert('다시 한 번 생각해보세요.');
			} else {
				this.util.alert('응답 횟수를 초과하였습니다.');
				this.dtPg.isUcInput31 = true;
				this.dtPg.resultUcInput31 = this.dtPg.passUcInput31;
			}
	...
	sendUcInput32()
	{
		...
		if (this.dtPg.resultUcInput32 == -1)
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput32 == this.dtPg.passUcInput32) {
			this.util.alert('잘 하셨습니다.');
			this.dtPg.isUcInput32 = true;
			return;
		} else {
			this.dtPg.countUcInput32--;

			if (this.dtPg.countUcInput32 >= 0) {
				this.util.alert('다시 한 번 생각해보세요.');
			} else {
				this.util.alert('응답 횟수를 초과하였습니다.');
				this.dtPg.isUcInput32 = true;
				this.dtPg.resultUcInput32 = this.dtPg.passUcInput32;
			}
