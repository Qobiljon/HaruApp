...
import { Ht3Pg25Data } from './ht3_pg25.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg25',
  templateUrl: 'ht3_pg25.html',
})
export class Ht3Pg25Page {

	/* Common */
	pgConfig = new Ht3PgConfig(25);
