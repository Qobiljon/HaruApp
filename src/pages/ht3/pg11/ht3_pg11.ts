...
import { Ht3Pg11Data } from './ht3_pg11.data';
...
@IonicPage()
@Component({
  selector: 'ht3-page-pg11',
  templateUrl: 'ht3_pg11.html',
})
export class Ht3Pg11Page {

	/* Common */
	pgConfig = new Ht3PgConfig(11);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg11Page');
	}
	...
	showUcData13()
	{
		...
		let result3:number = Math.abs(this.dtPg.countTodayFeelRating) - Math.abs(this.dtPg.countUcFeelRating10);
