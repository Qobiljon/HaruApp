...
import { Ht3Pg23Data } from './ht3_pg23.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg23',
  templateUrl: 'ht3_pg23.html',
})
export class Ht3Pg23Page {

	/* Common */
	pgConfig = new Ht3PgConfig(23);
