...
import { Ht3Pg39Data } from './ht3_pg39.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg39',
  templateUrl: 'ht3_pg39.html',
})
export class Ht3Pg39Page {

	/* Common */
	pgConfig = new Ht3PgConfig(39);
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput26) {
			...
			if (this.dtPg.resultUcInput27[1] == false &&
				this.dtPg.resultUcInput27[2] == false &&
				this.dtPg.resultUcInput27[3] == false &&
				this.dtPg.resultUcInput27[4] == false )
			{
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput26) {
			this.showUcInput26();
