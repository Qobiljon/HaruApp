...
import { Ht3Pg30Data } from './ht3_pg30.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg30',
  templateUrl: 'ht3_pg30.html',
})
export class Ht3Pg30Page {

	/* Common */
	pgConfig = new Ht3PgConfig(30);
