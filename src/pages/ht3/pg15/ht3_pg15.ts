...
import { Ht3Pg15Data } from './ht3_pg15.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg15',
  templateUrl: 'ht3_pg15.html',
})
export class Ht3Pg15Page {

	/* Common */
	pgConfig = new Ht3PgConfig(15);
