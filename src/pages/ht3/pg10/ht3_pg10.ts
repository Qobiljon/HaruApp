...
import { Ht3Pg10Data } from './ht3_pg10.data';
import { Ht3Pg09Data } from '../pg09/ht3_pg09.data';
import { Ht3Pg08Data } from '../pg08/ht3_pg08.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg10',
  templateUrl: 'ht3_pg10.html',
})
export class Ht3Pg10Page {

	/* Common */
	pgConfig = new Ht3PgConfig(10);
	...
	showUcData13()
	{
		...
		let result2:number = Math.abs(this.dtPg.countTodayFeelRating) - Math.abs(this.dtPg.countUcFeelRating10);
