...
import { Ht3Pg32Data } from './ht3_pg32.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg32',
  templateUrl: 'ht3_pg32.html',
})
export class Ht3Pg32Page {

	/* Common */
	pgConfig = new Ht3PgConfig(32);
