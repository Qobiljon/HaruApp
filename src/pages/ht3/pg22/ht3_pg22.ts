...
@IonicPage()
@Component({
  selector: 'ht3-page-pg22',
  templateUrl: 'ht3_pg22.html',
})
export class Ht3Pg22Page {

	/* Common */
	pgConfig = new Ht3PgConfig(22);
	...
	/* User Custom */
	dtPg1st = new Ht3Pg20Data();
	dtPg = new Ht3Pg22Data();
	...
	loadUcData()
	{
		...
		let dtPg1st = new Ht3Pg20Data();
		dtPg1st = this.storage.getObject('dtPg20');
