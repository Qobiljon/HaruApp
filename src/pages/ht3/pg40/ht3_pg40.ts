...
import { Ht3Pg40Data } from './ht3_pg40.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg40',
  templateUrl: 'ht3_pg40.html',
})
export class Ht3Pg40Page {

	/* Common */
	pgConfig = new Ht3PgConfig(40);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg40Page');
	}
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput19) {
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput19) {
			this.showUcInput19();
