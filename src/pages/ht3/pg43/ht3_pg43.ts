...
import { Ht3Pg43Data } from './ht3_pg43.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg43',
  templateUrl: 'ht3_pg43.html',
})
export class Ht3Pg43Page {

	/* Common */
	pgConfig = new Ht3PgConfig(43);
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput16) {
			...
			if ((this.dtPg.resultUcInput18[1] == true && this.dtPg.resultUcInput22[1] == -1) ||
				(this.dtPg.resultUcInput18[2] == true && this.dtPg.resultUcInput22[2] == -1) ||
				(this.dtPg.resultUcInput18[3] == true && this.dtPg.resultUcInput22[3] == -1) ||
				(this.dtPg.resultUcInput18[4] == true && this.dtPg.resultUcInput22[4] == -1) ||
				(this.dtPg.resultUcInput18[5] == true && this.dtPg.resultUcInput22[5] == -1) )
			{
				this.util.toast('보기의 항목을 선택하세요.');
				return false;
