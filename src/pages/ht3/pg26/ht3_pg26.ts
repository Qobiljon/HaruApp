...
import { Ht3Pg26Data } from './ht3_pg26.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg26',
  templateUrl: 'ht3_pg26.html',
})
export class Ht3Pg26Page {

	/* Common */
	pgConfig = new Ht3PgConfig(26);
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData35 && this.dtPg.resultUcInput30 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData33;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput31 && this.dtPg.resultUcInput30 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput30;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData35 && this.dtPg.resultUcInput30 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData34;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData34 && this.dtPg.resultUcInput30 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput30;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput30 && this.dtPg.resultUcInput30 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcInput31;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData33 && this.dtPg.resultUcInput30 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData35;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput30 && this.dtPg.resultUcInput30 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData34;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData34 && this.dtPg.resultUcInput30 == 2) {
				// 분기#2
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput8) {
			...
			if (this.dtPg.resultUcInput21 == -1)
			{
				this.util.toast('보기의 항목을 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput21 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
			...
			if (this.dtPg.isUcInput28 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput30) {
			if (this.dtPg.isUcInput30 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
			...
			if (this.dtPg.isUcInput37 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		}
	...
	changeHourUp(num)
	{
		if (num == 28)
		{
			if (this.dtPg.resultUcInput28.hour < 9) {
				this.dtPg.resultUcInput28.hour += 1;
			}
		}
	}
	...
	changeHourDown(num)
	{
		if (num == 28)
		{
			if (this.dtPg.resultUcInput28.hour > 0) {
				this.dtPg.resultUcInput28.hour -= 1;
			}
		}
	}
	...
	changeMinUp(num)
	{
		if (num == 28)
		{
			if (this.dtPg.resultUcInput28.min == 55) {
				this.dtPg.resultUcInput28.min = 0;
			} else {
				this.dtPg.resultUcInput28.min += 5;
			}
		}
	}
	...
	changeMinDown(num)
	{
		if (num == 28)
		{
			if (this.dtPg.resultUcInput28.min == 0) {
				this.dtPg.resultUcInput28.min = 55;
			} else {
				this.dtPg.resultUcInput28.min -= 5;
			}
		}
	...
	sendUcInput28()
	{
		...
		this.util.alert('해당 시간을 설정하셨습니다.');
	...
	selectMinDown(num)
	{
		if (num == 31)
		{
			if (this.dtPg.resultUcInput31 > 0)
				this.dtPg.resultUcInput31 -= 1;
		} else if (num == 32) {
			if (this.dtPg.resultUcInput32 > 0)
				this.dtPg.resultUcInput32 -= 1;
		} 
	}
	...
	selectMinUp(num)
	{
		if (num == 31)
		{
			if (this.dtPg.resultUcInput31 < 29)
				this.dtPg.resultUcInput31 += 1;
		} else if (num == 32) {
			if (this.dtPg.resultUcInput32 < 29)
				this.dtPg.resultUcInput32 += 1;
		}
	}
