...
import { Ht3Pg28Data } from './ht3_pg28.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg28',
  templateUrl: 'ht3_pg28.html',
})
export class Ht3Pg28Page {

	/* Common */
	pgConfig = new Ht3PgConfig(28);
