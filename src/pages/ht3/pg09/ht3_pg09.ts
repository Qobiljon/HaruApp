...
import { Ht3Pg09Data } from './ht3_pg09.data';
import { Ht3Pg08Data } from '../pg08/ht3_pg08.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg09',
  templateUrl: 'ht3_pg09.html',
})
export class Ht3Pg09Page {

	/* Common */
	pgConfig = new Ht3PgConfig(9);
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData15 && this.dtPg.resultUcData11 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData12;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData12 && this.dtPg.resultUcData11 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData11;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData15 && this.dtPg.resultUcData11 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData13;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData13 && this.dtPg.resultUcData11 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData11;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData15 && this.dtPg.resultUcData11 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData14;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData14 && this.dtPg.resultUcData11 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData11;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData11 && this.dtPg.resultUcData11 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData12;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData12 && this.dtPg.resultUcData11 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData15;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData11 && this.dtPg.resultUcData11 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData13;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData13 && this.dtPg.resultUcData11 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData15;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData11 && this.dtPg.resultUcData11 == 3) {
				// 분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData14;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData14 && this.dtPg.resultUcData11 == 3) {
				// 분기#3
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneTodayFeelRating) {
			...
			if (this.dtPg.countUcFeelRating10 == -1) {
				this.util.toast('이때의 기분평점을 선택하세요.');
				return false;
	...
	showPage()
	{
		...
		} else if (this.item.ht_userdata == this.dtPg.sceneUcData11) {
			this.showUcData11();
	...
	showUcData11()
	{
		...
		if (this.dtPg.countTodayFeelRating < this.dtPg.countUcFeelRating10) {
			this.dtPg.resultUcData11 = 1;
		} else if (this.dtPg.countTodayFeelRating == this.dtPg.countUcFeelRating10) {
			this.dtPg.resultUcData11 = 2;
		} else {
			this.dtPg.resultUcData11 = 3;
		}

		console.log('showUcData11()', this.dtPg.resultUcData11);
	}
	...
	sendUcFeelRating10()
	{
		console.log("sendUcFeelRating10", this.dtPg.countUcFeelRating10);
