...
import { Ht3Pg07Data } from './ht3_pg07.data';
import { Ht3Pg02Data } from '../pg02/ht3_pg02.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg07',
  templateUrl: 'ht3_pg07.html',
})
export class Ht3Pg07Page {

	/* Common */
	pgConfig = new Ht3PgConfig(7);
	end_zone_num = 1;
	...
	/* User Custom */
	dtPg1st = new Ht3Pg02Data();
	dtPg = new Ht3Pg07Data();
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg07Page');
	}
	...
	loadUcData()
	{
		...
		let dtPg1st = new Ht3Pg02Data();
		dtPg1st = this.storage.getObject('dtPg02');
