...
import { Ht3Pg06Data } from './ht3_pg06.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg06',
  templateUrl: 'ht3_pg06.html',
})
export class Ht3Pg06Page {

	/* Common */
	pgConfig = new Ht3PgConfig(6);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg06Page');
	}
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData40 && this.dtPg.selectUcInput37 == 1 ) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData38;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData38 && this.dtPg.selectUcInput37 == 1 ) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput37;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData40 && this.dtPg.selectUcInput37 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData39;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData39 && this.dtPg.selectUcInput37 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput37;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput37 && this.dtPg.selectUcInput37 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData38;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData38 && this.dtPg.selectUcInput37 == 1 ) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData40;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput37 && this.dtPg.selectUcInput37 == 2 ) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData39;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData39 && this.dtPg.selectUcInput37 == 2 ) {
				// 분기#2
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput37) {
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput37) {
			this.showUcInput37();
	...
	showUcInput37()
	{
		console.log('showUcInput37()');

		if (this.dtPg.resultUcInput37 == 1 || this.dtPg.resultUcInput37 == 3 || this.dtPg.resultUcInput37 == 5) {
			this.dtPg.selectUcInput37 = 1;
		} else if (this.dtPg.resultUcInput37 == 2 || this.dtPg.resultUcInput37 == 4) {
			this.dtPg.selectUcInput37 = 2;
		}
	...
	sendUcInput37()
	{
		...
		if (this.dtPg.resultUcInput37 == -1)
		{
