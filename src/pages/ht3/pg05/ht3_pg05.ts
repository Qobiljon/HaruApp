...
import { Ht3Pg05Data } from './ht3_pg05.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg05',
  templateUrl: 'ht3_pg05.html',
})
export class Ht3Pg05Page {

	/* Common */
	pgConfig = new Ht3PgConfig(5);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg05Page');
	}
