...
import { Ht3Pg44Data } from './ht3_pg44.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg44',
  templateUrl: 'ht3_pg44.html',
})
export class Ht3Pg44Page {

	/* Common */
	pgConfig = new Ht3PgConfig(44);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg44Page');
	}
