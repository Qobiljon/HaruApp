...
import { Ht3Pg36Data } from './ht3_pg36.data';

@IonicPage()
@Component({
  selector: 'ht3-page-pg36',
  templateUrl: 'ht3_pg36.html',
})
export class Ht3Pg36Page {

	/* Common */
	pgConfig = new Ht3PgConfig(36);
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput8) {
			if (this.dtPg.resultUcInput8[1] == false &&
				this.dtPg.resultUcInput8[2] == false &&
				this.dtPg.resultUcInput8[3] == false &&
				this.dtPg.resultUcInput8[4] == false &&
				this.dtPg.resultUcInput8[5] == false &&
				this.dtPg.resultUcInput8[6] == false &&
				this.dtPg.resultUcInput8[7] == false &&
				this.dtPg.resultUcInput8[8] == false &&
				this.dtPg.resultUcInput8[9] == false )
			{
			...
			if (this.dtPg.resultUcInput26 == -1)
			{
				this.util.toast('보기의 답을 을택하세요.');
				return false;
	...
	sendUcInput8()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput8) {
				...
				this.dtPg.resultUcInput8[9] == false)
			{
				...
				this.dtPg.selectUcInput8[1] = 0;
				this.dtPg.selectUcInput8[2] = 0;
				this.dtPg.selectUcInput8[3] = 0;

				for (let i=1; i < 10; i++)
				{
					if (this.dtPg.resultUcInput8[i] == true)
					{
						if (this.dtPg.passUcInput8[1][1] == i ||
							this.dtPg.passUcInput8[1][2] == i ||
							this.dtPg.passUcInput8[1][3] == i)
						{
							console.log('passUcInput8[1]', i);
							this.dtPg.selectUcInput8[1] += 1;
						}

						if (this.dtPg.passUcInput8[2][1] == i ||
							this.dtPg.passUcInput8[2][2] == i ||
							this.dtPg.passUcInput8[2][3] == i)
						{
							console.log('passUcInput8[2]', i);
							this.dtPg.selectUcInput8[2] += 1;
						}

						if (this.dtPg.passUcInput8[3][1] == i ||
							this.dtPg.passUcInput8[3][2] == i ||
							this.dtPg.passUcInput8[3][3] == i)
						{
							console.log('passUcInput8[3]', i);
							this.dtPg.selectUcInput8[3] += 1;
						}
					}
				}
	...
	sendUcInput26()
	{
		console.log('sendUcInput26()');

		if (this.dtPg.resultUcInput26 == -1)
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput26 == this.dtPg.passUcInput26) {
			this.util.alert('잘 하셨습니다.');
			this.dtPg.isUcInput26 = true;
		} else {

			this.dtPg.countUcInput26--;

			if (this.dtPg.countUcInput26 >= 0) {
				this.util.alert('다시 한 번 생각해보세요. 다시 한번 생각해 보세요.');
			} else {
				this.util.alert('다시 한 번 생각해보세요. 응답 횟수를 초과하였습니다.');
				this.dtPg.isUcInput26 = true;
				this.dtPg.resultUcInput26 = this.dtPg.passUcInput26;
			}
	...
	sendUcInput40()
	{
		...
		if (this.dtPg.resultUcInput40 == -1)
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput40 == this.dtPg.passUcInput40) {
			this.util.alert('잘 하셨습니다.');
			this.dtPg.isUcInput40 = true;
		} else {

			this.dtPg.countUcInput40--;

			if (this.dtPg.countUcInput40 >= 0) {
				this.util.alert('다시 한 번 생각해보세요. 다시 한번 생각해 보세요.');
			} else {
				this.util.alert('다시 한 번 생각해보세요. 응답 횟수를 초과하였습니다.');
				this.dtPg.isUcInput40 = true;
				this.dtPg.resultUcInput40 = this.dtPg.passUcInput40;
			}
	...
	sendUcInput42()
	{
		...
		if (this.dtPg.resultUcInput42 == -1)
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput42 == this.dtPg.passUcInput42) {
			this.util.alert('잘 하셨습니다.');
			this.dtPg.isUcInput42 = true;
		} else {

			this.dtPg.countUcInput42--;

			if (this.dtPg.countUcInput42 >= 0) {
				this.util.alert('다시 한 번 생각해보세요. 다시 한번 생각해 보세요.');
			} else {
				this.util.alert('다시 한 번 생각해보세요. 응답 횟수를 초과하였습니다.');
				this.dtPg.isUcInput42 = true;
				this.dtPg.resultUcInput42 = this.dtPg.passUcInput42;
			}
	...
	sendUcInput52()
	{
		...
		if (this.dtPg.resultUcInput52 == -1)
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput52 == this.dtPg.passUcInput52) {
			this.util.alert('잘 하셨습니다.');
			this.dtPg.isUcInput52 = true;
		} else {

			this.dtPg.countUcInput52--;

			if (this.dtPg.countUcInput52 >= 0) {
				this.util.alert('다시 한 번 생각해보세요. 다시 한번 생각해 보세요.');
			} else {
				this.util.alert('다시 한 번 생각해보세요. 응답 횟수를 초과하였습니다.');
				this.dtPg.isUcInput52 = true;
				this.dtPg.resultUcInput52 = this.dtPg.passUcInput52;
			}
	...
	sendUcInput54()
	{
		...
		if (this.dtPg.resultUcInput54 == -1)
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput54 == this.dtPg.passUcInput54) {
			this.util.alert('잘 하셨습니다.');
			this.dtPg.isUcInput54 = true;
		} else {

			this.dtPg.countUcInput54--;

			if (this.dtPg.countUcInput54 >= 0) {
				this.util.alert('다시 한 번 생각해보세요. 다시 한번 생각해 보세요.');
			} else {
				this.util.alert('다시 한 번 생각해보세요. 응답 횟수를 초과하였습니다.');
				this.dtPg.isUcInput54 = true;
				this.dtPg.resultUcInput54 = this.dtPg.passUcInput54;
			}
