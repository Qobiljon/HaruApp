...
import { LocalNotificationsProvider } from '../../../providers/ht1/local-notifications/local-notifications';

@IonicPage()
@Component({
  selector: 'ht1-page-login',
  templateUrl: 'ht1_login.html',
})
export class Ht1LoginPage {
