...
import { Ht1Pg30Data } from './ht1_pg30.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg30',
  templateUrl: 'ht1_pg30.html',
})
export class Ht1Pg30Page {

	/* Common */
	pgConfig = new Ht1PgConfig(30);
