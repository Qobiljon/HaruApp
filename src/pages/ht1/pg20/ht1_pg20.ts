...
import { Ht1Pg20Data } from './ht1_pg20.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg20',
  templateUrl: 'ht1_pg20.html',
})
export class Ht1Pg20Page {

	/* Common */
	pgConfig = new Ht1PgConfig(20);
