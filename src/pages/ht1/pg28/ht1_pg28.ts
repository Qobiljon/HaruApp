...
import { Ht1Pg28Data } from './ht1_pg28.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg28',
  templateUrl: 'ht1_pg28.html',
})
export class Ht1Pg28Page {

	/* Common */
	pgConfig = new Ht1PgConfig(28);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg28Page');
	}
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData12 && this.dtPg.resultUcInput9 == 1 ) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData10;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData10 && this.dtPg.resultUcInput9 == 1 ) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput9;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData12 && (this.dtPg.resultUcInput9 == 2 || this.dtPg.resultUcInput9 == 3 || this.dtPg.resultUcInput9 == 4) ) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData11;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData11 && (this.dtPg.resultUcInput9 == 2 || this.dtPg.resultUcInput9 == 3 || this.dtPg.resultUcInput9 == 4)  ) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput9;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput9 && this.dtPg.resultUcInput9 == 1 ) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData10;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData10 && this.dtPg.resultUcInput9 == 1 ) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData12;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput9 && (this.dtPg.resultUcInput9 == 2 || this.dtPg.resultUcInput9 == 3 || this.dtPg.resultUcInput9 == 4) ) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData11;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData11 && (this.dtPg.resultUcInput9 == 2 || this.dtPg.resultUcInput9 == 3 || this.dtPg.resultUcInput9 == 4) ) {
				// 분기#2
	...
	sendUcInput9()
	{
		...
		if (this.dtPg.resultUcInput9 == -1)
		{
			...
			this.util.alert('보기의 항목을 선택하셨습니다.');
