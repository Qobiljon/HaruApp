...
import { Ht1Pg39Data } from './ht1_pg39.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg39',
  templateUrl: 'ht1_pg39.html',
})
export class Ht1Pg39Page {

	/* Common */
	pgConfig = new Ht1PgConfig(39);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg39Page');
	}
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput25) {
			...
			if (this.dtPg.resultUcInput26[1] == false &&
				this.dtPg.resultUcInput26[2] == false &&
				this.dtPg.resultUcInput26[3] == false &&
				this.dtPg.resultUcInput26[4] == false )
			{
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput25) {
			this.showUcInput25();
