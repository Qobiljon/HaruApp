...
import { Ht1Pg06Data } from './ht1_pg06.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg06',
  templateUrl: 'ht1_pg06.html',
})
export class Ht1Pg06Page {

	/* Common */
	pgConfig = new Ht1PgConfig(6);
	end_zone_num = 1;
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg6Page');
	}
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput16) {
			if ((this.dtPg.resultUcInput16[1] == false &&
				this.dtPg.resultUcInput16[2] == false &&
				this.dtPg.resultUcInput16[3] == false &&
				this.dtPg.resultUcInput16[4] == false) ||
				(this.dtPg.resultUcInput16[5] == false &&
				this.dtPg.resultUcInput16[6] == false &&
				this.dtPg.resultUcInput16[7] == false &&
				this.dtPg.resultUcInput16[8] == false) )
			{
			...
			if (this.dtPg.isBtnUcInput19[1] == false ||
				this.dtPg.isBtnUcInput19[2] == false ||
				this.dtPg.isBtnUcInput19[3] == false ||
				this.dtPg.isBtnUcInput19[4] == false)
			{
				this.util.toast('보기의 답을 선택하세요.');
				return false;
			...
			if (this.dtPg.resultUcInput25[1] == -1 &&
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput16) {
			this.showUcInput16();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcInput19) {
			this.showUcInput19();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcInput25) {
			this.showUcInput25();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcInput27) {
			this.showUcInput27();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcData31) {
			this.showUcData31();
		}
	...
	showUcInput27()
	{
		console.log('showUcInput27()');
		return;
	}

	showUcData31()
	{
		console.log('showUcData31()');
		return;
	}
	...
	sendUcInput16()
	{
		...
		if ( (this.dtPg.resultUcInput16[1] == false && this.dtPg.resultUcInput16[2] == false && this.dtPg.resultUcInput16[3] == false && this.dtPg.resultUcInput16[4] == false) || (this.dtPg.resultUcInput16[5] == false && this.dtPg.resultUcInput16[6] == false && this.dtPg.resultUcInput16[7] == false && this.dtPg.resultUcInput16[8] == false) )
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput16[1] == this.dtPg.passUcInput16[1] &&
			this.dtPg.resultUcInput16[2] == this.dtPg.passUcInput16[2] &&
			this.dtPg.resultUcInput16[3] == this.dtPg.passUcInput16[3] &&
			this.dtPg.resultUcInput16[4] == this.dtPg.passUcInput16[4] &&
			this.dtPg.resultUcInput16[5] == this.dtPg.passUcInput16[5] &&
			this.dtPg.resultUcInput16[6] == this.dtPg.passUcInput16[6] &&
			this.dtPg.resultUcInput16[7] == this.dtPg.passUcInput16[7] &&
			this.dtPg.resultUcInput16[8] == this.dtPg.passUcInput16[8] )
		{
			...
			this.dtPg.countUcInput16--;

			if (this.dtPg.countUcInput16 >= 0) {
				this.util.alert('다시 한 번 생각해보세요.');
			} else {
				this.util.alert('다시 한 번 생각해보세요. 응답 횟수를 초과하였습니다.');
				this.dtPg.isUcInput16 = true;
				this.dtPg.resultUcInput16 = this.dtPg.passUcInput16;
			}
	...
	{
		if (val == 1) {
			this.dtPg.isBtnUcInput19[1] = true;

			if (this.dtPg.resultUcInput19[1] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[1] = '지';
				return;
			}
			if (this.dtPg.resultUcInput19[2] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[2] = '지';
				return;
			}
			if (this.dtPg.resultUcInput19[3] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[3] = '지';
				return;
			}
			if (this.dtPg.resultUcInput19[4] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[4] = '지';
				return;
			}
		} else if (val == 2) {
			this.dtPg.isBtnUcInput19[2] = true;

			if (this.dtPg.resultUcInput19[1] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[1] = '동';
				return;
			}
			if (this.dtPg.resultUcInput19[2] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[2] = '동';
				return;
			}
			if (this.dtPg.resultUcInput19[3] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[3] = '동';
				return;
			}
			if (this.dtPg.resultUcInput19[4] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[4] = '동';
				return;
			}
		} else if (val == 3) {
			this.dtPg.isBtnUcInput19[3] = true;

			if (this.dtPg.resultUcInput19[1] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[1] = '행';
				return;
			}
			if (this.dtPg.resultUcInput19[2] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[2] = '행';
				return;
			}
			if (this.dtPg.resultUcInput19[3] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[3] = '행';
				return;
			}
			if (this.dtPg.resultUcInput19[4] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[4] = '행';
				return;
			}
		} else if (val == 4) {
			this.dtPg.isBtnUcInput19[4] = true;

			if (this.dtPg.resultUcInput19[1] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[1] = '인';
				return;
			}
			if (this.dtPg.resultUcInput19[2] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[2] = '인';
				return;
			}
			if (this.dtPg.resultUcInput19[3] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[3] = '인';
				return;
			}
			if (this.dtPg.resultUcInput19[4] == "&nbsp;&nbsp;") {
				this.dtPg.resultUcInput19[4] = '인';
				return;
			}
		} else if (val == 5) {
			this.dtPg.resultUcInput19[1] = "&nbsp;&nbsp;";
			this.dtPg.resultUcInput19[2] = "&nbsp;&nbsp;";
			this.dtPg.resultUcInput19[3] = "&nbsp;&nbsp;";
			this.dtPg.resultUcInput19[4] = "&nbsp;&nbsp;";
			this.dtPg.isBtnUcInput19[1] = false;
			this.dtPg.isBtnUcInput19[2] = false;
			this.dtPg.isBtnUcInput19[3] = false;
			this.dtPg.isBtnUcInput19[4] = false;
		}
	...
	sendUcInput19()
	{
			...
			this.dtPg.isBtnUcInput19[4] == false)
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput19[1] == this.dtPg.passUcInput19[1] &&
			this.dtPg.resultUcInput19[2] == this.dtPg.passUcInput19[2] &&
			this.dtPg.resultUcInput19[3] == this.dtPg.passUcInput19[3] &&
			this.dtPg.resultUcInput19[4] == this.dtPg.passUcInput19[4] )
		{
			this.util.alert('잘 하셨습니다.');
	...
	sendUcInput25()
	{
			...
			this.dtPg.resultUcInput25[3] == -1 )
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput25[1] == this.dtPg.passUcInput25[1] &&
			this.dtPg.resultUcInput25[2] == this.dtPg.passUcInput25[2] &&
			this.dtPg.resultUcInput25[3] == this.dtPg.passUcInput25[3] )
		{
			this.util.alert('잘 하셨습니다.');
	...
	sendUcInput27()
	{
		...
		if (this.dtPg.resultUcInput27 == -1)
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput27 == this.dtPg.passUcInput27) {
			this.util.alert('잘 하셨습니다.');
			this.dtPg.isUcInput27 = true;
			return;
		} else {
			this.dtPg.countUcInput27--;

			if (this.dtPg.countUcInput27 >= 0) {
				this.util.alert('다시 한 번 생각해보세요.');
			} else {
				this.util.alert('응답 횟수를 초과하였습니다.');
				this.dtPg.isUcInput27 = true;
				this.dtPg.resultUcInput27 = this.dtPg.passUcInput27;
			}
