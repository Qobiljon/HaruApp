...
import { Ht1Pg09Data } from './ht1_pg09.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg09',
  templateUrl: 'ht1_pg09.html',
})
export class Ht1Pg09Page {

	/* Common */
	pgConfig = new Ht1PgConfig(9);
	...
	showUcData8()
	{
		console.log('showUcData8() passed!');
		return;
	}

	showUcData10()
	{
		console.log('showUcData10() passed!');
		return;
	}

	showUcData12()
	{
		console.log('showUcData12() passed!');
		return;
	}

	showUcData14()
	{
		console.log('showUcData14() passed!');
		return;
	}

	showUcData17()
	{
		console.log('showUcData17() passed!');
		return;
	}

	showUcData26()
	{
		console.log('showUcData26() passed!');
		return;
	}
