...
import { Ht1Pg11Data } from './ht1_pg11.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg11',
  templateUrl: 'ht1_pg11.html',
})
export class Ht1Pg11Page {

	/* Common */
	pgConfig = new Ht1PgConfig(11);
