...
import { Ht1Pg40Data } from './ht1_pg40.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg40',
  templateUrl: 'ht1_pg40.html',
})
export class Ht1Pg40Page {

	/* Common */
	pgConfig = new Ht1PgConfig(40);
