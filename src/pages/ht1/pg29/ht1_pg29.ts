...
import { Ht1Pg29Data } from './ht1_pg29.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg29',
  templateUrl: 'ht1_pg29.html',
})
export class Ht1Pg29Page {

	/* Common */
	pgConfig = new Ht1PgConfig(29);
	...
	showPage()
	{
		...
		} else if (this.item.ht_userdata == this.dtPg.sceneUcFeelRating16) {
