...
import { Ht1Pg46Data } from './ht1_pg46.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg46',
  templateUrl: 'ht1_pg46.html',
})
export class Ht1Pg46Page {

	/* Common */
	pgConfig = new Ht1PgConfig(46);
