...
import { Ht1Pg01Data } from './ht1_pg01.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg01',
  templateUrl: 'ht1_pg01.html',
})
export class Ht1Pg01Page {

	/* Common */
	pgConfig = new Ht1PgConfig(1);
