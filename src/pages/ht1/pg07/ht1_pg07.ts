...
import { Ht1Pg07Data } from './ht1_pg07.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg07',
  templateUrl: 'ht1_pg07.html',
})
export class Ht1Pg07Page {

	/* Common */
	pgConfig = new Ht1PgConfig(7);
	...
	/* User Custom */
	dtPg:Ht1Pg07Data = new Ht1Pg07Data();
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg7Page');
	}
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData47 && this.dtPg.selectUcData43 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData44;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData44 && this.dtPg.selectUcData43 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData43;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData47 && this.dtPg.selectUcData43 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData45;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData45 && this.dtPg.selectUcData43 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData43;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData47 && this.dtPg.selectUcData43 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData46;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData46 && this.dtPg.selectUcData43 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData43;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput54 && this.dtPg.resultUcInput49 == 1) {
			// 선택분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData50;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData50 && this.dtPg.resultUcInput49 == 1) {
			// 선택분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput49;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput54 && this.dtPg.resultUcInput49 == 2) {
			// 선택분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData51;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData51 && this.dtPg.resultUcInput49 == 2) {
			// 선택분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput49;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput54 && this.dtPg.resultUcInput49 == 3) {
			// 선택분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData52;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData52 && this.dtPg.resultUcInput49 == 3) {
			// 선택분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput49;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput54 && this.dtPg.resultUcInput49 == 4) {
			// 선택분기#4
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData53;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData53 && this.dtPg.resultUcInput49 == 4) {
			// 선택분기#4
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput49;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData43 && this.dtPg.selectUcData43 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData44;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData44 && this.dtPg.selectUcData43 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData47;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData43 && this.dtPg.selectUcData43 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData45;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData45 && this.dtPg.selectUcData43 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData47;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData43 && this.dtPg.selectUcData43 == 3) {
				// 분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData46;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData46 && this.dtPg.selectUcData43 == 3) {
				// 분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData47;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput49 && this.dtPg.resultUcInput49 == 1) {
				// 선택분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData50;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData50 && this.dtPg.resultUcInput49 == 1) {
				// 선택분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcInput54;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput49 && this.dtPg.resultUcInput49 == 2) {
				// 선택분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData51;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData51 && this.dtPg.resultUcInput49 == 2) {
				// 선택분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcInput54;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput49 && this.dtPg.resultUcInput49 == 3) {
				// 선택분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData52;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData52 && this.dtPg.resultUcInput49 == 3) {
				// 선택분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcInput54;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput49 && this.dtPg.resultUcInput49 == 4) {
				// 선택분기#4
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData53;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData53 && this.dtPg.resultUcInput49 == 4) {
				// 선택분기#4
	...
	checkInput()
	{
		...
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput49) {
			if (this.dtPg.resultUcInput49 == -1) {
				this.util.toast('보기의 항목을 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput49 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput54) {
			if (this.dtPg.resultUcInput54 == -1)
			{
				this.util.toast('보기의 활동을 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput54 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcData43 && this.dtPg.selectUcData43 != -1) {
			this.sortTimeChart();
		}

		if (this.item.ht_userdata == this.dtPg.sceneUcData44 || this.item.ht_userdata == this.dtPg.sceneUcData45 || this.item.ht_userdata == this.dtPg.sceneUcData46) {
	...
	sortTimeChart()
	{
		...
		let result = [
			{ rank: 1, point: this.dtPg.resultUcFeelRating1, input: this.dtPg.resultUcInput1 },
			{ rank: 2, point: this.dtPg.resultUcFeelRating2, input: this.dtPg.resultUcInput2 },
			{ rank: 3, point: this.dtPg.resultUcFeelRating3, input: this.dtPg.resultUcInput3 },
			{ rank: 4, point: this.dtPg.resultUcFeelRating4, input: this.dtPg.resultUcInput4 },
			{ rank: 5, point: this.dtPg.resultUcFeelRating5, input: this.dtPg.resultUcInput5 }
		];
		...
		if ((result[0].point - result[4].point) >= 3) {
			this.dtPg.selectUcData43 = 1;
		} else if (result[0].point - result[4].point > 0 && result[0].point - result[4].point < 3) {
			this.dtPg.selectUcData43 = 2;
		} else {
			this.dtPg.selectUcData43 = 3;
		}

		this.dtPg.resultUcData43 = result;
	...
	drawTimeChart()
	{
		...
		if (this.item.ht_tpcode == 'hcst044' || this.item.ht_tpcode == 'hcst045' || this.item.ht_tpcode == 'hcst046') {
			setTimeout(() => {
