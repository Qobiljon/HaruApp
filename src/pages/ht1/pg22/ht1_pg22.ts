...
import { Ht1Pg22Data } from './ht1_pg22.data';
import { Ht1Pg14Data } from '../pg14/ht1_pg14.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg22',
  templateUrl: 'ht1_pg22.html',
})
export class Ht1Pg22Page {

	/* Common */
	pgConfig = new Ht1PgConfig(22);
