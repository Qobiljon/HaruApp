...
@IonicPage()
@Component({
  selector: 'ht1-page-pg16',
  templateUrl: 'ht1_pg16.html',
})
export class Ht1Pg16Page {

	/* Common */
	pgConfig = new Ht1PgConfig(16);
	...
	showUcData12()
	{
		...
		let result2:number = Math.abs(this.dtPg.countTodayFeelRating) - Math.abs(this.dtPg.countUcFeelRating9);
		...
		console.log('showUcData12()', this.dtPg.resultUcData12);
