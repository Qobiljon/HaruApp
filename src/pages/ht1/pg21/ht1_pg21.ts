...
import { Ht1Pg21Data } from './ht1_pg21.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg21',
  templateUrl: 'ht1_pg21.html',
})
export class Ht1Pg21Page {

	/* Common */
	pgConfig = new Ht1PgConfig(21);
