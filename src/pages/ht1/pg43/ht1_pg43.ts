...
import { Ht1Pg43Data } from './ht1_pg43.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg43',
  templateUrl: 'ht1_pg43.html',
})
export class Ht1Pg43Page {

	/* Common */
	pgConfig = new Ht1PgConfig(43);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg43Page');
	}
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput15) {
			...
			if ((this.dtPg.resultUcInput17[1] == true && this.dtPg.resultUcInput21[1] == -1) ||
				(this.dtPg.resultUcInput17[2] == true && this.dtPg.resultUcInput21[2] == -1) ||
				(this.dtPg.resultUcInput17[3] == true && this.dtPg.resultUcInput21[3] == -1) ||
				(this.dtPg.resultUcInput17[4] == true && this.dtPg.resultUcInput21[4] == -1) ||
				(this.dtPg.resultUcInput17[5] == true && this.dtPg.resultUcInput21[5] == -1) )
			{
				this.util.toast('보기의 항목을 선택하세요.');
				return false;
