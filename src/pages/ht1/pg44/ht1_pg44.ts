...
import { Ht1Pg44Data } from './ht1_pg44.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg44',
  templateUrl: 'ht1_pg44.html',
})
export class Ht1Pg44Page {

	/* Common */
	pgConfig = new Ht1PgConfig(44);
