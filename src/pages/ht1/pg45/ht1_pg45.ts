...
import { Ht1Pg45Data } from './ht1_pg45.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg45',
  templateUrl: 'ht1_pg45.html',
})
export class Ht1Pg45Page {

	/* Common */
	pgConfig = new Ht1PgConfig(45);
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput12) {
			if (this.dtPg.resultUcInput12[1] == false &&
				this.dtPg.resultUcInput12[2] == false &&
				this.dtPg.resultUcInput12[3] == false &&
				this.dtPg.resultUcInput12[4] == false )
			{
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput12) {
			this.showUcInput12();
	...
	sendUcInput12()
	{
			...
			this.dtPg.resultUcInput12[4] == false )
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput12[1] == this.dtPg.passUcInput12[1] &&
			this.dtPg.resultUcInput12[2] == this.dtPg.passUcInput12[2] &&
			this.dtPg.resultUcInput12[3] == this.dtPg.passUcInput12[3] &&
			this.dtPg.resultUcInput12[4] == this.dtPg.passUcInput12[4] )
		{
