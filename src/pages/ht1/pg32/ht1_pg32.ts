...
import { Ht1Pg32Data } from './ht1_pg32.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg32',
  templateUrl: 'ht1_pg32.html',
})
export class Ht1Pg32Page {

	/* Common */
	pgConfig = new Ht1PgConfig(32);
