...
import { Ht1Pg24Data } from './ht1_pg24.data';
import { Ht1Pg22Data } from '../pg22/ht1_pg22.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg24',
  templateUrl: 'ht1_pg24.html',
})
export class Ht1Pg24Page {

	/* Common */
	pgConfig = new Ht1PgConfig(24);
	end_zone_num = 3;
	...
	/* User Custom */
	dtPg1st = new Ht1Pg22Data();
	dtPg = new Ht1Pg24Data();
	...
	loadUcData()
	{
		...
		let dtPg1st = new Ht1Pg22Data();
		dtPg1st = this.storage.getObject('dtPg22');
