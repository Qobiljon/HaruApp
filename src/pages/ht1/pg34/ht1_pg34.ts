...
import { Ht1Pg34Data } from './ht1_pg34.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg34',
  templateUrl: 'ht1_pg34.html',
})
export class Ht1Pg34Page {

	/* Common */
	pgConfig = new Ht1PgConfig(34);
