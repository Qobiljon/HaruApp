...
import { Ht1Pg02Data } from './ht1_pg02.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg02',
  templateUrl: 'ht1_pg02.html',
})
export class Ht1Pg02Page {

	/* Common */
	pgConfig = new Ht1PgConfig(2);
