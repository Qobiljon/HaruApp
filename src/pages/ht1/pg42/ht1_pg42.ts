...
import { Ht1Pg42Data } from './ht1_pg42.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg42',
  templateUrl: 'ht1_pg42.html',
})
export class Ht1Pg42Page {

	/* Common */
	pgConfig = new Ht1PgConfig(42);
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput27) {
