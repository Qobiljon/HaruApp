...
import { Ht1Pg23Data } from './ht1_pg23.data';
import { Ht1Pg14Data } from '../pg14/ht1_pg14.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg23',
  templateUrl: 'ht1_pg23.html',
})
export class Ht1Pg23Page {

	/* Common */
	pgConfig = new Ht1PgConfig(23);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg23Page');
	}
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput4) {
		...
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput6) {
			if (this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][1] == -1 ||
				this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][2] == -1 ||
				this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][3] == -1 ||
				this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][4] == -1 ||
				this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][5] == -1)
			{
		...
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcUnrestRating9) {
			if (this.dtPg.isUcUnrestRating9 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput11) {
		...
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcUnrestRating13) {
			if (this.dtPg.isUcUnrestRating13 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		...
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcUnrestRating18) {
			if (this.dtPg.isUcUnrestRating18 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		...
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcUnrestRating23) {
			if (this.dtPg.isUcUnrestRating23 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		...
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcUnrestRating28) {
			if (this.dtPg.isUcUnrestRating28 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		...
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcUnrestRating33) {
			if (this.dtPg.isUcUnrestRating33 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
	...
	showUcAudio(base_audio, sound)
	{
		...
		if (sound != '' && this.pgConfig.volumeState == '1')
		{
			if (this.pgConfig.isDebugClearData)
				this.util.toast(base_audio + 'common/'+ sound);
	...
	sendUnrestOrder(sceneNum, num)
	{
		if (sceneNum == 4)
		{
			this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][num] = this.dtPg.stepUcInput6[this.dtPg.resultUcInput4];
			this.dtPg.resultUcInput6[this.dtPg.resultUcInput4][this.dtPg.stepUcInput6[this.dtPg.resultUcInput4]] = num;
			this.dtPg.stepUcInput6[this.dtPg.resultUcInput4]++;
		}
	}
	...
	sendUnrestClear(sceneNum)
	{
		if (sceneNum == 4)
		{
			this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][1] = -1;
			this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][2] = -1;
			this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][3] = -1;
			this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][4] = -1;
			this.dtPg.orderUcInput6[this.dtPg.resultUcInput4][5] = -1;
			this.dtPg.resultUcInput6[this.dtPg.resultUcInput4][1] = -1;
			this.dtPg.resultUcInput6[this.dtPg.resultUcInput4][2] = -1;
			this.dtPg.resultUcInput6[this.dtPg.resultUcInput4][3] = -1;
			this.dtPg.resultUcInput6[this.dtPg.resultUcInput4][4] = -1;
			this.dtPg.resultUcInput6[this.dtPg.resultUcInput4][5] = -1;
			this.dtPg.stepUcInput6[this.dtPg.resultUcInput4] = 1;
		}
	}
	...
	{
		if (num == 9) {
			if (this.dtPg.countUcUnrestRating9 < 10) {
				this.dtPg.countUcUnrestRating9 += 1;
			}
		}

		if (num == 13) {
			if (this.dtPg.countUcUnrestRating13 < 10) {
				this.dtPg.countUcUnrestRating13 += 1;
			}
		}
		...
		if (num == 18) {
			if (this.dtPg.countUcUnrestRating18 < 10) {
				this.dtPg.countUcUnrestRating18 += 1;
			}
		}
		...
		if (num == 23) {
			if (this.dtPg.countUcUnrestRating23 < 10) {
				this.dtPg.countUcUnrestRating23 += 1;
			}
		}
		...
		if (num == 28) {
			if (this.dtPg.countUcUnrestRating28 < 10) {
				this.dtPg.countUcUnrestRating28 += 1;
			}
		}
		...
		if (num == 33) {
			if (this.dtPg.countUcUnrestRating33 < 10) {
				this.dtPg.countUcUnrestRating33 += 1;
			}
		}
	}
	...
	{
		if (num == 9) {
			if (this.dtPg.countUcUnrestRating9 > 0) {
				this.dtPg.countUcUnrestRating9 -= 1;
			}
		}

		if (num == 13) {
			if (this.dtPg.countUcUnrestRating13 > 0) {
				this.dtPg.countUcUnrestRating13 -= 1;
			}
		}
		...
		if (num == 18) {
			if (this.dtPg.countUcUnrestRating18 > 0) {
				this.dtPg.countUcUnrestRating18 -= 1;
			}
		}
		...
		if (num == 23) {
			if (this.dtPg.countUcUnrestRating23 > 0) {
				this.dtPg.countUcUnrestRating23 -= 1;
			}
		}
		...
		if (num == 28) {
			if (this.dtPg.countUcUnrestRating28 > 0) {
				this.dtPg.countUcUnrestRating28 -= 1;
			}
		}
		...
		if (num == 33) {
			if (this.dtPg.countUcUnrestRating33 > 0) {
				this.dtPg.countUcUnrestRating33 -= 1;
			}
		}
	}
	...
	{
		if (num == 9) {
			this.dtPg.isUcUnrestRating9 = true;
		}

		if (num == 13) {
			this.dtPg.isUcUnrestRating13 = true;
		}
		...
		if (num == 18) {
			this.dtPg.isUcUnrestRating18 = true;
		}
		...
		if (num == 23) {
			this.dtPg.isUcUnrestRating23 = true;
		}
		...
		if (num == 28) {
			this.dtPg.isUcUnrestRating28 = true;
		}
		...
		if (num == 33) {
			this.dtPg.isUcUnrestRating33 = true;
		}
