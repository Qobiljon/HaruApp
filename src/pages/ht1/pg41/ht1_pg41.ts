...
import { Ht1Pg41Data } from './ht1_pg41.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg41',
  templateUrl: 'ht1_pg41.html',
})
export class Ht1Pg41Page {

	/* Common */
	pgConfig = new Ht1PgConfig(41);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg41Page');
	}
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData20 && this.dtPg.resultUcInput16 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData17;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData17 && this.dtPg.resultUcInput16 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput16;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData20 && this.dtPg.resultUcInput16 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData18;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData18 && this.dtPg.resultUcInput16 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput16;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData20 && this.dtPg.resultUcInput16 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData19;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData19 && this.dtPg.resultUcInput16 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput16;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput16 && this.dtPg.resultUcInput16 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData17;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData17 && this.dtPg.resultUcInput16 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData20;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput16 && this.dtPg.resultUcInput16 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData18;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData18 && this.dtPg.resultUcInput16 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData20;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput16 && this.dtPg.resultUcInput16 == 3) {
				// 분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData19;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData19 && this.dtPg.resultUcInput16 == 3) {
				// 분기#3
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput13) {
			if ((this.dtPg.resultUcInput13[1] == false &&
				this.dtPg.resultUcInput13[2] == false &&
				this.dtPg.resultUcInput13[3] == false &&
				this.dtPg.resultUcInput13[4] == false &&
				this.dtPg.resultUcInput13[5] == false &&
				this.dtPg.resultUcInput13[6] == false) ||
				(this.dtPg.resultUcInput13[7] == false &&
				this.dtPg.resultUcInput13[8] == false &&
				this.dtPg.resultUcInput13[9] == false &&
				this.dtPg.resultUcInput13[10] == false &&
				this.dtPg.resultUcInput13[11] == false &&
				this.dtPg.resultUcInput13[12] == false) )
			{
			...
			if ((this.dtPg.resultUcInput14[1] == false &&
				this.dtPg.resultUcInput14[2] == false &&
				this.dtPg.resultUcInput14[3] == false &&
				this.dtPg.resultUcInput14[4] == false &&
				this.dtPg.resultUcInput14[5] == false &&
				this.dtPg.resultUcInput14[6] == false) ||
				(this.dtPg.resultUcInput14[7] == false &&
				this.dtPg.resultUcInput14[8] == false &&
				this.dtPg.resultUcInput14[9] == false &&
				this.dtPg.resultUcInput14[10] == false &&
				this.dtPg.resultUcInput14[11] == false &&
				this.dtPg.resultUcInput14[12] == false) )
			{
				this.util.toast('보기의 답을 선택하세요.');
				return false;
			...
			if ((this.dtPg.resultUcInput15[1] == false &&
				this.dtPg.resultUcInput15[2] == false &&
				this.dtPg.resultUcInput15[3] == false &&
				this.dtPg.resultUcInput15[4] == false &&
				this.dtPg.resultUcInput15[5] == false &&
				this.dtPg.resultUcInput15[6] == false) ||
				(this.dtPg.resultUcInput15[7] == false &&
				this.dtPg.resultUcInput15[8] == false &&
				this.dtPg.resultUcInput15[9] == false &&
				this.dtPg.resultUcInput15[10] == false &&
				this.dtPg.resultUcInput15[11] == false &&
				this.dtPg.resultUcInput15[12] == false) )
			{
				this.util.toast('보기의 답을 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput15 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput13) {
			this.showUcInput13();
