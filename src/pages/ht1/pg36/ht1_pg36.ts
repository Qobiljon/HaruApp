...
import { Ht1Pg36Data } from './ht1_pg36.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg36',
  templateUrl: 'ht1_pg36.html',
})
export class Ht1Pg36Page {

	/* Common */
	pgConfig = new Ht1PgConfig(36);
