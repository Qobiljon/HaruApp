...
@IonicPage()
@Component({
  selector: 'ht1-page-pg03',
  templateUrl: 'ht1_pg03.html',
})
export class Ht1Pg03Page {

	/* Common */
	pgConfig = new Ht1PgConfig(3);
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput9) {
			if (this.dtPg.resultUcInput9[1] == false &&
				this.dtPg.resultUcInput9[2] == false &&
				this.dtPg.resultUcInput9[3] == false &&
				this.dtPg.resultUcInput9[4] == false &&
				this.dtPg.resultUcInput9[5] == false &&
				this.dtPg.resultUcInput9[6] == false &&
				this.dtPg.resultUcInput9[7] == false &&
				this.dtPg.resultUcInput9[8] == false )
			{
	...
	sendUcInput9()
	{
			...
			this.dtPg.resultUcInput9[8] == false )
		{
			this.util.toast('보기의 답을 선택하세요.');
			return;
		} else if (this.dtPg.resultUcInput9[1] == this.dtPg.passUcInput9[1] &&
			this.dtPg.resultUcInput9[2] == this.dtPg.passUcInput9[2] &&
			this.dtPg.resultUcInput9[3] == this.dtPg.passUcInput9[3] &&
			this.dtPg.resultUcInput9[4] == this.dtPg.passUcInput9[4] &&
			this.dtPg.resultUcInput9[5] == this.dtPg.passUcInput9[5] &&
			this.dtPg.resultUcInput9[6] == this.dtPg.passUcInput9[6] &&
			this.dtPg.resultUcInput9[7] == this.dtPg.passUcInput9[7] &&
			this.dtPg.resultUcInput9[8] == this.dtPg.passUcInput9[8] )
		{
			...
			for (let custom of this.dtPg.resultUcInput9) {
				if (custom == true)
					checkCount++;
			}
			...
			if (this.dtPg.countUcInput9 >= 0) {
				if (checkCount < 4)
				{
					this.util.toast('다시 한 번 생각해보세요. 보기의 답을 추가로 선택하세요.');
				}
				else if (checkCount < 4)
				{
					this.util.toast('다시 한 번 생각해보세요. 보기의 답을 적게 선택하세요.');
				} else {
