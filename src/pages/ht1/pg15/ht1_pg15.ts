...
import { Ht1Pg15Data } from './ht1_pg15.data';
import { Ht1Pg14Data } from '../pg14/ht1_pg14.data';

@IonicPage()
@Component({
  selector: 'ht1-page-pg15',
  templateUrl: 'ht1_pg15.html',
})
export class Ht1Pg15Page {

	/* Common */
	pgConfig = new Ht1PgConfig(15);
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData14 && this.dtPg.resultUcData10 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData11;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData11 && this.dtPg.resultUcData10 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData10;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData14 && this.dtPg.resultUcData10 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData12;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData12 && this.dtPg.resultUcData10 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData10;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData14 && this.dtPg.resultUcData10 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData13;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData13 && this.dtPg.resultUcData10 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData10;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData10 && this.dtPg.resultUcData10 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData11;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData11 && this.dtPg.resultUcData10 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData14;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData10 && this.dtPg.resultUcData10 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData12;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData12 && this.dtPg.resultUcData10 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData14;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData10 && this.dtPg.resultUcData10 == 3) {
				// 분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData13;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData13 && this.dtPg.resultUcData10 == 3) {
				// 분기#3
