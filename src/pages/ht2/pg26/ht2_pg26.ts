...
import { Ht2Pg26Data } from './ht2_pg26.data';
import { Ht2Pg24Data } from '../pg24/ht2_pg24.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg26',
  templateUrl: 'ht2_pg26.html',
})
export class Ht2Pg26Page {

	/* Common */
	pgConfig = new Ht2PgConfig(26);
	end_zone_num = 3;
	...
	/* User Custom */
	dtPg1st = new Ht2Pg24Data();
	dtPg = new Ht2Pg26Data();
	...
	loadUcData()
	{
		...
		let dtPg1st = new Ht2Pg24Data();
		dtPg1st = this.storage.getObject('dtPg24');
