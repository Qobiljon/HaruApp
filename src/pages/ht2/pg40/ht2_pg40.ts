...
import { Ht2Pg40Data } from './ht2_pg40.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg40',
  templateUrl: 'ht2_pg40.html',
})
export class Ht2Pg40Page {

	/* Common */
	pgConfig = new Ht2PgConfig(40);
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput21) {
			this.showUcInput21();
