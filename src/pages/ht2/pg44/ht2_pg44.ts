...
import { Ht2Pg44Data } from './ht2_pg44.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg44',
  templateUrl: 'ht2_pg44.html',
})
export class Ht2Pg44Page {

	/* Common */
	pgConfig = new Ht2PgConfig(44);
