...
import { Ht2Pg33Data } from './ht2_pg33.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg33',
  templateUrl: 'ht2_pg33.html',
})
export class Ht2Pg33Page {

	/* Common */
	pgConfig = new Ht2PgConfig(33);
