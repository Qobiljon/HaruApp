...
import { Ht2Pg19Data } from './ht2_pg19.data';
...
@IonicPage()
@Component({
  selector: 'ht2-page-pg19',
  templateUrl: 'ht2_pg19.html',
})
export class Ht2Pg19Page {

	/* Common */
	pgConfig = new Ht2PgConfig(19);
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcAudio10) {
			this.showUcAudio(this.item.ht_base_audio, this.item.ht_text2);
		} else if (this.item.ht_userdata == this.dtPg.sceneTodayFeelRating) {
