...
import { Ht2Pg43Data } from './ht2_pg43.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg43',
  templateUrl: 'ht2_pg43.html',
})
export class Ht2Pg43Page {

	/* Common */
	pgConfig = new Ht2PgConfig(43);
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput18) {
			...
			if ((this.dtPg.resultUcInput20[1] == true && this.dtPg.resultUcInput24[1] == -1) ||
				(this.dtPg.resultUcInput20[2] == true && this.dtPg.resultUcInput24[2] == -1) ||
				(this.dtPg.resultUcInput20[3] == true && this.dtPg.resultUcInput24[3] == -1) ||
				(this.dtPg.resultUcInput20[4] == true && this.dtPg.resultUcInput24[4] == -1) ||
				(this.dtPg.resultUcInput20[5] == true && this.dtPg.resultUcInput24[5] == -1) )
			{
				this.util.toast('보기의 항목을 선택하세요.');
				return false;
