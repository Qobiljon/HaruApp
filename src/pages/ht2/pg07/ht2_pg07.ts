...
import { Ht2Pg07Data } from './ht2_pg07.data';
import { Ht2Pg06Data } from '../pg06/ht2_pg06.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg07',
  templateUrl: 'ht2_pg07.html',
})
export class Ht2Pg07Page {

	/* Common */
	pgConfig = new Ht2PgConfig(7);
	end_zone_num = 1;
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData51 && this.dtPg1st.selectUcInput38 == 1 ) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData49;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData49 && this.dtPg1st.selectUcInput38 == 1 ) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData48;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData51 && this.dtPg1st.selectUcInput38 == 2 ) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData50;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData50 && this.dtPg1st.selectUcInput38 == 2 ) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData48;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData48 && this.dtPg1st.selectUcInput38 == 1 ) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData49;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData49 && this.dtPg1st.selectUcInput38 == 1 ) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData51;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData48 && this.dtPg1st.selectUcInput38 == 2 ) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData50;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData50 && this.dtPg1st.selectUcInput38 == 2 ) {
				// 분기#2
