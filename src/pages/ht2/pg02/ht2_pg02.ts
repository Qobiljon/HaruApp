...
import { Ht2Pg02Data } from './ht2_pg02.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg02',
  templateUrl: 'ht2_pg02.html',
})
export class Ht2Pg02Page {

	/* Common */
	pgConfig = new Ht2PgConfig(2);
	...
	initTodaySleep()
	{
		...
		console.log('수면평가 상태 : ', this.pgConfig.isTodaySleepRating);
	}
