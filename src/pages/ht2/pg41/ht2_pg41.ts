...
import { Ht2Pg41Data } from './ht2_pg41.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg41',
  templateUrl: 'ht2_pg41.html',
})
export class Ht2Pg41Page {

	/* Common */
	pgConfig = new Ht2PgConfig(41);
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData23 && this.dtPg.resultUcInput19 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData20;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData20 && this.dtPg.resultUcInput19 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput19;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData23 && this.dtPg.resultUcInput19 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData21;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData21 && this.dtPg.resultUcInput19 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput19;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData23 && this.dtPg.resultUcInput19 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData22;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData22 && this.dtPg.resultUcInput19 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput19;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput19 && this.dtPg.resultUcInput19 == 1) {
				...
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData23;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput19 && this.dtPg.resultUcInput19 == 3) {
				// 분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData22;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData22 && this.dtPg.resultUcInput19 == 3) {
				// 분기#3
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput16) {
			...
			if ((this.dtPg.resultUcInput17[1] == false &&
				...
				this.dtPg.resultUcInput17[11] == false &&
				this.dtPg.resultUcInput17[12] == false) )
			{
				this.util.toast('보기의 답을 선택하세요.');
				return false;
			...
			if ((this.dtPg.resultUcInput18[1] == false &&
				...
				(this.dtPg.resultUcInput18[7] == false &&
				this.dtPg.resultUcInput18[8] == false &&
				this.dtPg.resultUcInput18[9] == false &&
				this.dtPg.resultUcInput18[10] == false &&
				this.dtPg.resultUcInput18[11] == false &&
				this.dtPg.resultUcInput18[12] == false) )
			{
				this.util.toast('보기의 답을 선택하세요.');
				return false;
