...
import { Ht2Pg05Data } from './ht2_pg05.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg05',
  templateUrl: 'ht2_pg05.html',
})
export class Ht2Pg05Page {

	/* Common */
	pgConfig = new Ht2PgConfig(5);
