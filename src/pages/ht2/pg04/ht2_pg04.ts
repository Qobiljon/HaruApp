...
import { Ht2Pg04Data } from './ht2_pg04.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg04',
  templateUrl: 'ht2_pg04.html',
})
export class Ht2Pg04Page {

	/* Common */
	pgConfig = new Ht2PgConfig(4);
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData23) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput22;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData25) {
			// 분기#2 분기#3 분기#4
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput22;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData38 && this.dtPg.resultUcInput22 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData24;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData24 && this.dtPg.resultUcInput22 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData23;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData38 && this.dtPg.resultUcInput22 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData34;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData31 && this.dtPg.resultUcInput22 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData25;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData35 && this.dtPg.resultUcInput22 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData25;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData38 && this.dtPg.resultUcInput22 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData37;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData38 && this.dtPg.resultUcInput22 == 4) {
			// 분기#4
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData30;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData26 && this.dtPg.resultUcInput22 == 4) {
			// 분기#4
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData25;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput22 && this.dtPg.resultUcInput22 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData23;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput22 && 
				(this.dtPg.resultUcInput22 == 2 || this.dtPg.resultUcInput22 == 3 || this.dtPg.resultUcInput22 == 4) ) {
				// 분기#2 분기#3 분기#4
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData25;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData24 && this.dtPg.resultUcInput22 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData38;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData25 && this.dtPg.resultUcInput22 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData31;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData34 && this.dtPg.resultUcInput22 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData38;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData25 && this.dtPg.resultUcInput22 == 3) {
				// 분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData35;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData37 && this.dtPg.resultUcInput22 == 3) {
				// 분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData38;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData25 && this.dtPg.resultUcInput22 == 4) {
				// 분기#4
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData26;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData30 && this.dtPg.resultUcInput22 == 4) {
				// 분기#4
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData38;
			} else {
				this.pgConfig.sceneNumber++;
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput22) {
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput22) {
			this.showUcInput22();
		}
