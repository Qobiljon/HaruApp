...
import { Ht2Pg18Data } from './ht2_pg18.data';
import { Ht2Pg17Data } from '../pg17/ht2_pg17.data';
import { Ht2Pg16Data } from '../pg16/ht2_pg16.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg18',
  templateUrl: 'ht2_pg18.html',
})
export class Ht2Pg18Page {

	/* Common */
	pgConfig = new Ht2PgConfig(18);
	...
	showUcData15()
	{
		...
		let result2:number = Math.abs(this.dtPg.countTodayFeelRating) - Math.abs(this.dtPg.countUcFeelRating12);
		...
		console.log('showUcData15()', this.dtPg.resultUcData15);
