...
import { Ht2Pg09Data } from './ht2_pg09.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg09',
  templateUrl: 'ht2_pg09.html',
})
export class Ht2Pg09Page {

	/* Common */
	pgConfig = new Ht2PgConfig(9);
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData21 && this.dtPg.selectUcInput18 == 1 ) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData19;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData19 && this.dtPg.selectUcInput18 == 1 ) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput18;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData21 && this.dtPg.selectUcInput18 == 2 ) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData20;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData20 && this.dtPg.selectUcInput18 == 2 ) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput18;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData37 && this.dtPg.selectUcInput34 == 1 ) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData35;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData35 && this.dtPg.selectUcInput34 == 1 ) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcInput34;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData37 && this.dtPg.selectUcInput34 == 2 ) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData36;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData36 && this.dtPg.selectUcInput34 == 2 ) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.selectUcInput34;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput18 && this.dtPg.selectUcInput18 == 1 ) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData19;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData19 && this.dtPg.selectUcInput18 == 1 ) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData21;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput18 && this.dtPg.selectUcInput18 == 2 ) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData20;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData20 && this.dtPg.selectUcInput18 == 2 ) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData21;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput34 && this.dtPg.selectUcInput34 == 1 ) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData35;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData35 && this.dtPg.selectUcInput34 == 1 ) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData37;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput34 && this.dtPg.selectUcInput34 == 2 ) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData36;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData36 && this.dtPg.selectUcInput34 == 2 ) {
				// 분기#2
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput18) {
			...
			if (this.dtPg.resultUcInput34[1] == false &&
				...
				this.dtPg.resultUcInput34[5] == false
			) {
				this.util.toast('보기의 답을 선택하세요.');
				return false;
			...
			if (this.dtPg.resultUcInput46[1] == false &&
				this.dtPg.resultUcInput46[2] == false &&
				this.dtPg.resultUcInput46[3] == false &&
				this.dtPg.resultUcInput46[4] == false &&
				this.dtPg.resultUcInput46[5] == false &&
				this.dtPg.resultUcInput46[6] == false &&
				this.dtPg.resultUcInput46[7] == false &&
				this.dtPg.resultUcInput46[8] == false
			) {
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcInput18) {
			this.showUcInput18();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcInput34) {
			this.showUcInput34();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcInput46) {
			this.showUcInput46();
	...
	showUcInput18()
	{
		...
		if (this.dtPg.resultUcInput18[1] == false &&
			...
			this.dtPg.selectUcInput18 = 1;

			return;
		} else {
			this.dtPg.selectUcInput18 = 2;
	...
	showUcInput34()
	{
		...
		if (this.dtPg.resultUcInput34[1] == false &&
			...
			this.dtPg.resultUcInput34[5] == this.dtPg.passUcInput34[5]
		) {
			this.dtPg.selectUcInput34 = 1;

			return;
		} else {
			this.dtPg.selectUcInput34 = 2;
