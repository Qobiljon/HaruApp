...
import { Ht2Pg38Data } from './ht2_pg38.data';
import { Ht2Pg37Data } from '../pg37/ht2_pg37.data';
import { Ht2Pg29Data } from '../pg29/ht2_pg29.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg38',
  templateUrl: 'ht2_pg38.html',
})
export class Ht2Pg38Page {

	/* Common */
	pgConfig = new Ht2PgConfig(38);
	end_zone_num = 4;
	...
	/* User Custom */
	dtPg1st = new Ht2Pg29Data();
	dtPg2nd = new Ht2Pg37Data();
	dtPg = new Ht2Pg38Data();
	...
	loadUcData()
	{
		...
		let dtPg1st = new Ht2Pg29Data();
		dtPg1st = this.storage.getObject('dtPg29');
		...
		let dtPg2nd = new Ht2Pg37Data();
		dtPg2nd = this.storage.getObject('dtPg37');
