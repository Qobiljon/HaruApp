...
import { Ht2Pg23Data } from './ht2_pg23.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg23',
  templateUrl: 'ht2_pg23.html',
})
export class Ht2Pg23Page {

	/* Common */
	pgConfig = new Ht2PgConfig(23);
