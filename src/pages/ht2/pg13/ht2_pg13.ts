...
import { Ht2Pg13Data } from './ht2_pg13.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg13',
  templateUrl: 'ht2_pg13.html',
})
export class Ht2Pg13Page {

	/* Common */
	pgConfig = new Ht2PgConfig(13);
