...
@IonicPage()
@Component({
  selector: 'ht2-page-home',
  templateUrl: 'ht2_home.html'
})
export class Ht2HomePage {
	/* Common */
	pgConfig = new Ht2PgConfig(0);
	...
	ratingText: string = '오늘하루 수면효율 그래프';
	...
	setAlarmSound() {
		if (this.platform.is('android')) {
			return 'file://assets/ht2/audio/alarm.mp3'
		} else {
			return 'file://assets/ht2/audio/alarm.caf'
		}
	}
	...
	postHaruTodayMenu()
	{
		...
		let pgConfig = new Ht2PgConfig(0);
	...
	postHaruTodayLoadUserData(todayCount)
	{
		...
		let pgConfig = new Ht2PgConfig(todayCount);
