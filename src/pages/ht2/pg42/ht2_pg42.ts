...
import { Ht2Pg42Data } from './ht2_pg42.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg42',
  templateUrl: 'ht2_pg42.html',
})
export class Ht2Pg42Page {

	/* Common */
	pgConfig = new Ht2PgConfig(42);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg42Page');
	}
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput30) {
			...
			if (this.dtPg.resultUcQuiz1 == -1) {
				this.util.toast('보기의 답을 모두 선택하세요.');
				return false;
