...
import { Ht2Pg28Data } from './ht2_pg28.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg28',
  templateUrl: 'ht2_pg28.html',
})
export class Ht2Pg28Page {

	/* Common */
	pgConfig = new Ht2PgConfig(28);
