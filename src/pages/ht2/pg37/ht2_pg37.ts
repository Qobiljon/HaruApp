...
import { Ht2Pg37Data } from './ht2_pg37.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg37',
  templateUrl: 'ht2_pg37.html',
})
export class Ht2Pg37Page {

	/* Common */
	pgConfig = new Ht2PgConfig(37);
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == 30) {
			// 29번 씬 jump
			this.pgConfig.sceneNumber -= 2;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == 28) {
				// 29번 씬 jump
				this.pgConfig.sceneNumber += 2;
			} else {
				this.pgConfig.sceneNumber++;
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput23) {
			if (this.dtPg.countUcInput23 == -1) {
				this.util.toast('이때의 생각점수를 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput23 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput24) {
			if (this.dtPg.countUcInput24 == -1) {
				this.util.toast('이때의 생각점수를 선택하세요.');
				return false;
		...
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput26) {
			if (this.dtPg.countUcInput26 == -1) {
				this.util.toast('이때의 생각점수를 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput26 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput40) {
			if (this.dtPg.countUcInput40 == -1) {
				this.util.toast('이때의 생각점수를 선택하세요.');
				return false;
		...
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput55) {
			if (this.dtPg.countUcInput55 == -1) {
				this.util.toast('이때의 생각점수를 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput55 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput56) {
			if (this.dtPg.countUcInput56 == -1) {
				this.util.toast('이때의 생각점수를 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput56 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput57) {
			if (this.dtPg.countUcInput57 == -1) {
				this.util.toast('이때의 생각점수를 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput57 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput71) {
			if (this.dtPg.countUcInput71 == -1) {
				this.util.toast('이때의 생각점수를 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput71 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput72) {
			if (this.dtPg.countUcInput72 == -1) {
				this.util.toast('이때의 생각점수를 선택하세요.');
				return false;
			} else if (this.dtPg.isUcInput72 == false) {
				this.util.alert('제출하기 버튼을 선택하세요.');
				return false;
			}
	...
	showPage()
	{
		...
		if (this.item.ht_userdata == this.dtPg.sceneUcData27) {
			this.showUcData27();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcData28) {
			this.showUcData28();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcData43) {
			this.showUcData43();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcData44) {
			this.showUcData44();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcData58) {
			this.showUcData58();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcData59) {
			this.showUcData59();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcData73) {
			this.showUcData73();
		} else if (this.item.ht_userdata == this.dtPg.sceneUcData74) {
			this.showUcData74();
		}
	...
	showUcData27()
	{
		console.log('showUcData27()');

		let sum:number = 0;
		sum += Number(this.dtPg.countUcInput23);
		sum += Number(this.dtPg.countUcInput24);
		sum += Number(this.dtPg.countUcInput25);
		sum += Number(this.dtPg.countUcInput26);

		this.dtPg.resultUcData27 = Math.ceil(sum / 4);
	...
	showUcData28()
	{
		console.log('showUcData28()');

		if (this.dtPg.resultUcData27 >= 0 && this.dtPg.resultUcData27 <= 3) {
			this.dtPg.resultUcData28 = 1;
		} else if (this.dtPg.resultUcData27 >= 4 && this.dtPg.resultUcData27 <= 6) {
			this.dtPg.resultUcData28 = 2;
		} else if (this.dtPg.resultUcData27 >= 7) {
			this.dtPg.resultUcData28 = 3;
		}
	...
	showUcData43()
	{
		console.log('showUcData43()');

		let sum:number = 0;
		sum += Number(this.dtPg.countUcInput40);
		sum += Number(this.dtPg.countUcInput41);
		sum += Number(this.dtPg.countUcInput42);

		this.dtPg.resultUcData43 = Math.ceil(sum / 3);
	...
	showUcData44()
	{
		console.log('showUcData44()');

		if (this.dtPg.resultUcData43 >= 0 && this.dtPg.resultUcData43 <= 3) {
			this.dtPg.resultUcData44 = 1;
		} else if (this.dtPg.resultUcData43 >= 4 && this.dtPg.resultUcData43 <= 6) {
			this.dtPg.resultUcData44 = 2;
		} else if (this.dtPg.resultUcData43 >= 7) {
			this.dtPg.resultUcData44 = 3;
		}
	...
	showUcData58()
	{
		console.log('showUcData58()');

		let sum:number = 0;
		sum += Number(this.dtPg.countUcInput55);
		sum += Number(this.dtPg.countUcInput56);
		sum += Number(this.dtPg.countUcInput57);

		this.dtPg.resultUcData58 = Math.ceil(sum / 3);
	...
	showUcData59()
	{
		console.log('showUcData59()');

		if (this.dtPg.resultUcData58 >= 0 && this.dtPg.resultUcData58 <= 3) {
			this.dtPg.resultUcData59 = 1;
		} else if (this.dtPg.resultUcData58 >= 4 && this.dtPg.resultUcData58 <= 6) {
			this.dtPg.resultUcData59 = 2;
		} else if (this.dtPg.resultUcData58 >= 7) {
			this.dtPg.resultUcData59 = 3;
		}
	...
	showUcData73()
	{
		console.log('showUcData73()');

		let sum:number = 0;
		sum += Number(this.dtPg.countUcInput71);
		sum += Number(this.dtPg.countUcInput72);

		this.dtPg.resultUcData73 = Math.ceil(sum / 2);
	...
	showUcData74()
	{
		console.log('showUcData74()');

		if (this.dtPg.resultUcData73 >= 0 && this.dtPg.resultUcData73 <= 3) {
			this.dtPg.resultUcData74 = 1;
		} else if (this.dtPg.resultUcData73 >= 4 && this.dtPg.resultUcData73 <= 6) {
			this.dtPg.resultUcData74 = 2;
		} else if (this.dtPg.resultUcData73 >= 7) {
			this.dtPg.resultUcData74 = 3;
		}
	...
	sendUcInput23()
	{
		console.log("sendUcInput23", this.dtPg.countUcInput23);
	...
	sendUcInput24()
	{
		console.log("sendUcInput24", this.dtPg.countUcInput24);
	...
	sendUcInput25()
	{
		console.log("sendUcInput25", this.dtPg.countUcInput25);
	...
	sendUcInput26()
	{
		console.log("sendUcInput26", this.dtPg.countUcInput26);
	...
	sendUcInput40()
	{
		console.log("sendUcInput40", this.dtPg.countUcInput40);
	...
	sendUcInput42()
	{
		console.log("sendUcInput42", this.dtPg.countUcInput42);
	...
	sendUcInput55()
	{
		console.log("sendUcInput55", this.dtPg.countUcInput55);
	...
	sendUcInput56()
	{
		console.log("sendUcInput56", this.dtPg.countUcInput56);
	...
	sendUcInput57()
	{
		console.log("sendUcInput57", this.dtPg.countUcInput57);
	...
	sendUcInput71()
	{
		console.log("sendUcInput71", this.dtPg.countUcInput71);
	...
	sendUcInput72()
	{
		console.log("sendUcInput72", this.dtPg.countUcInput72);
