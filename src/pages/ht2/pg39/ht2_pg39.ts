...
import { Ht2Pg39Data } from './ht2_pg39.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg39',
  templateUrl: 'ht2_pg39.html',
})
export class Ht2Pg39Page {

	/* Common */
	pgConfig = new Ht2PgConfig(39);
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput28) {
