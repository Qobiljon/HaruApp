...
import { Ht2Pg22Data } from './ht2_pg22.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg22',
  templateUrl: 'ht2_pg22.html',
})
export class Ht2Pg22Page {

	/* Common */
	pgConfig = new Ht2PgConfig(22);
