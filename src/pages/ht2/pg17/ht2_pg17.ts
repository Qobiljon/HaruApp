...
import { Ht2Pg17Data } from './ht2_pg17.data';
import { Ht2Pg16Data } from '../pg16/ht2_pg16.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg17',
  templateUrl: 'ht2_pg17.html',
})
export class Ht2Pg17Page {

	/* Common */
	pgConfig = new Ht2PgConfig(17);
	...
	goPrev()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData17 && this.dtPg.resultUcData13 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData14;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData14 && this.dtPg.resultUcData13 == 1) {
			// 분기#1
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData13;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData17 && this.dtPg.resultUcData13 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData15;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData15 && this.dtPg.resultUcData13 == 2) {
			// 분기#2
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData13;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData17 && this.dtPg.resultUcData13 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData16;
		} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData16 && this.dtPg.resultUcData13 == 3) {
			// 분기#3
			this.pgConfig.sceneNumber = this.dtPg.sceneUcData13;
		} else {
	...
	goNext()
	{
		...
		if (this.checkInput() == true)
		{
			...
			if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData13 && this.dtPg.resultUcData13 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData14;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData14 && this.dtPg.resultUcData13 == 1) {
				// 분기#1
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData17;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData13 && this.dtPg.resultUcData13 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData15;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData15 && this.dtPg.resultUcData13 == 2) {
				// 분기#2
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData17;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData13 && this.dtPg.resultUcData13 == 3) {
				// 분기#3
				this.pgConfig.sceneNumber = this.dtPg.sceneUcData16;
			} else if (this.pgConfig.sceneNumber == this.dtPg.sceneUcData16 && this.dtPg.resultUcData13 == 3) {
				// 분기#3
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneTodayFeelRating) {
			...
			if (this.dtPg.countUcFeelRating12 == -1) {
				this.util.toast('이때의 기분평점을 선택하세요.');
				return false;
	...
	showPage()
	{
		...
		} else if (this.item.ht_userdata == this.dtPg.sceneUcData13) {
			this.showUcData13();
	...
	showUcData13()
	{
		console.log('showUcData13()');

		if (this.dtPg.countTodayFeelRating < this.dtPg.countUcFeelRating12) {
			this.dtPg.resultUcData13 = 1;
		} else if (this.dtPg.countTodayFeelRating == this.dtPg.countUcFeelRating12) {
			this.dtPg.resultUcData13 = 2;
		} else {
			this.dtPg.resultUcData13 = 3;
		}

		console.log('showUcData13()', this.dtPg.resultUcData13);
	}
	...
	sendUcFeelRating12()
	{
		console.log("sendUcFeelRating12", this.dtPg.countUcFeelRating12);
