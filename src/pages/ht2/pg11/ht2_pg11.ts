...
import { Ht2Pg11Data } from './ht2_pg11.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg11',
  templateUrl: 'ht2_pg11.html',
})
export class Ht2Pg11Page {

	/* Common */
	pgConfig = new Ht2PgConfig(11);
