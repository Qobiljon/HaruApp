...
import { Ht2Pg30Data } from './ht2_pg30.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg30',
  templateUrl: 'ht2_pg30.html',
})
export class Ht2Pg30Page {

	/* Common */
	pgConfig = new Ht2PgConfig(30);
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad Pg30Page');
	}
	...
	sendUcInput60()
	{
		console.log("sendUcInput60", this.dtPg.countUcInput60);
