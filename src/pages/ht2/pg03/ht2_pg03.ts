...
import { Ht2Pg03Data } from './ht2_pg03.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg03',
  templateUrl: 'ht2_pg03.html',
})
export class Ht2Pg03Page {

	/* Common */
	pgConfig = new Ht2PgConfig(3);
	...
	checkInput()
	{
		...
		if (this.pgConfig.sceneNumber == this.dtPg.sceneUcInput14) {
			...
			if (this.dtPg.resultUcInput53[1] == false &&
				this.dtPg.resultUcInput53[2] == false &&
				this.dtPg.resultUcInput53[3] == false &&
				this.dtPg.resultUcInput53[4] == false &&
				this.dtPg.resultUcInput53[5] == false &&
				this.dtPg.resultUcInput53[6] == false )
			{
