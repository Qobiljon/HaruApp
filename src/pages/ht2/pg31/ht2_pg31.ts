...
import { Ht2Pg31Data } from './ht2_pg31.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg31',
  templateUrl: 'ht2_pg31.html',
})
export class Ht2Pg31Page {

	/* Common */
	pgConfig = new Ht2PgConfig(31);
