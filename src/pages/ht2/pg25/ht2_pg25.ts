...
import { Ht2Pg25Data } from './ht2_pg25.data';
import { Ht2Pg16Data } from '../pg16/ht2_pg16.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg25',
  templateUrl: 'ht2_pg25.html',
})
export class Ht2Pg25Page {

	/* Common */
	pgConfig = new Ht2PgConfig(25);
	...
	checkInput()
	{
		console.log('checkInput()', this.pgConfig.sceneNumber);
