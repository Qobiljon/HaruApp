...
import { Ht2Pg46Data } from './ht2_pg46.data';

@IonicPage()
@Component({
  selector: 'ht2-page-pg46',
  templateUrl: 'ht2_pg46.html',
})
export class Ht2Pg46Page {

	/* Common */
	pgConfig = new Ht2PgConfig(46);
